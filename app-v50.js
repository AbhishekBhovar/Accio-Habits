...
function renderJourney(){
  try{
    ...
    if(!root)return;
    root.innerHTML=`
      <section class="journey-art-shell" aria-label="Seven-book mountain journey">
        <img class="journey-art" src="./journey-mountain.png?v=49" alt="A dramatic mountain ascent with seven book checkpoints leading to a castle at the summit">
      </section>`;
  }catch(err){
...
const BATTLE_PROTO = {
categories:[
{id:'magic',icon:'✦',name:'Magic',desc:'Spells and magical abilities'},
{id:'skills',icon:'⌁',name:'Skills',desc:'Flying, stealth and practical ability'},
{id:'arsenal',icon:'⚔',name:'Arsenal',desc:'Weapons and useful equipment'},
{id:'knowledge',icon:'◈',name:'Knowledge',desc:'Intelligence Harry needs to win'},
{id:'allies',icon:'♟',name:'Allies',desc:'People who strengthen Harry'},
{id:'experience',icon:'⬟',name:'Experience',desc:'Combat, danger and survival'},
{id:'character',icon:'♥',name:'Character',desc:'Courage, judgment and sacrifice'},
{id:'horcrux',icon:'☠',name:'Horcrux War',desc:'The hidden war against immortality'}
],
items:[{"level":2,"book":1,"cat":"magic","name":"Latent Magic","state":"Awakened","detail":"Uncontrolled magic begins to surface."},{"level":5,"book":1,"cat":"knowledge","name":"Voldemort Dossier I","state":"Enemy Identified","detail":"Harry learns who murdered his parents and tried to kill him."},{"level":7,"book":1,"cat":"arsenal","name":"Harry's Wand","state":"Equipped","detail":"Harry acquires his primary magical weapon."},{"level":12,"book":1,"cat":"character","name":"Choice Over Ambition","state":"Proven","detail":"Harry chooses Gryffindor rather than Slytherin."},{"level":13,"book":1,"cat":"skills","name":"Flying","state":"Natural Aptitude","detail":"Harry discovers exceptional instinct in the air."},{"level":14,"book":1,"cat":"skills","name":"Flying","state":"Seeker Training","detail":"Quidditch begins sharpening speed, reactions and aerial tracking."},{"level":16,"book":1,"cat":"magic","name":"Wingardium Leviosa","state":"Combat Proven","detail":"Classroom magic becomes a real solution against the troll.","payoff":"Charms training \u2192 Troll victory"},{"level":16,"book":1,"cat":"allies","name":"The Trio","state":"Formed","detail":"Ron and Hermione become true allies, expanding Harry's effective abilities."},{"level":16,"book":1,"cat":"experience","name":"Troll Battle","state":"Survived","detail":"Harry's first serious combat encounter."},{"level":17,"book":1,"cat":"skills","name":"Flying","state":"Pressure Tested","detail":"Harry maintains control while his broom is being attacked."},{"level":18,"book":1,"cat":"arsenal","name":"Invisibility Cloak","state":"Equipped","detail":"A powerful stealth tool enters Harry's arsenal."},{"level":19,"book":1,"cat":"character","name":"Desire & Judgment","state":"Lesson Learned","detail":"The Mirror begins teaching Harry that desire can mislead."},{"level":20,"book":1,"cat":"skills","name":"Investigation","state":"Developing","detail":"Harry, Ron and Hermione solve the Nicolas Flamel mystery."},{"level":22,"book":1,"cat":"knowledge","name":"Voldemort Dossier II","state":"Threat Confirmed","detail":"The enemy is not merely history. Voldemort is still active."},{"level":23,"book":1,"cat":"skills","name":"Flying","state":"Applied Under Pressure","detail":"Harry catches the winged key beneath the trapdoor.","payoff":"Quidditch training \u2192 Winged Key"},{"level":23,"book":1,"cat":"allies","name":"Team Capability","state":"Proven","detail":"Ron's chess and Hermione's knowledge get Harry through trials he could not solve alone.","payoff":"Allies become part of Harry's arsenal"},{"level":24,"book":1,"cat":"experience","name":"Voldemort Encounter I","state":"Survived","detail":"Harry confronts Quirrell/Voldemort and survives."},{"level":24,"book":1,"cat":"character","name":"Mother's Protection","state":"Understood","detail":"Harry learns that sacrificial love protected him from Voldemort."},{"level":25,"book":2,"cat":"allies","name":"Dobby","state":"Potential Ally","detail":"A mysterious house-elf risks punishment to warn Harry."},{"level":28,"book":2,"cat":"allies","name":"Weasley Family","state":"Safe Haven","detail":"Harry gains a loving magical family and support network."},{"level":33,"book":2,"cat":"knowledge","name":"Chamber Investigation","state":"Opened","detail":"Harry begins tracking the unknown threat inside Hogwarts."},{"level":35,"book":2,"cat":"magic","name":"Expelliarmus","state":"Learned","detail":"Harry sees and begins acquiring the spell that will become central to his fighting identity."},{"level":36,"book":2,"cat":"magic","name":"Parseltongue","state":"Identified","detail":"Harry learns that his ability to speak to snakes is real."},{"level":37,"book":2,"cat":"skills","name":"Espionage","state":"Polyjuice Plan","detail":"The trio uses disguise and infiltration to gather intelligence."},{"level":39,"book":2,"cat":"knowledge","name":"Tom Riddle Dossier I","state":"Opened","detail":"The diary gives Harry direct access to Tom Riddle's past."},{"level":43,"book":2,"cat":"experience","name":"Acromantula Escape","state":"Survived","detail":"Harry and Ron investigate under mortal threat and eliminate Hagrid as the culprit."},{"level":44,"book":2,"cat":"knowledge","name":"Basilisk Intelligence","state":"Solved","detail":"Hermione's research identifies the monster and how it attacks."},{"level":45,"book":2,"cat":"magic","name":"Parseltongue","state":"Operational","detail":"A feared ability becomes useful when Harry opens the Chamber."},{"level":46,"book":2,"cat":"knowledge","name":"Tom Riddle = Voldemort","state":"Revealed","detail":"Harry finally connects the charming schoolboy in the diary to his enemy."},{"level":46,"book":2,"cat":"allies","name":"Fawkes","state":"Emergency Ally","detail":"Fawkes intervenes when Harry faces the Basilisk."},{"level":46,"book":2,"cat":"arsenal","name":"Sword of Gryffindor","state":"Earned","detail":"A weapon worthy of Gryffindor answers Harry in the Chamber."},{"level":47,"book":2,"cat":"experience","name":"Basilisk Battle","state":"Major Victory","detail":"Harry kills an enormous magical predator in direct combat."},{"level":47,"book":2,"cat":"arsenal","name":"Basilisk Venom","state":"Proven","detail":"The fang destroys Tom Riddle's diary. Its deeper importance remains unknown.","payoff":"Basilisk fang \u2192 Diary destroyed"},{"level":47,"book":2,"cat":"horcrux","name":"Unknown Soul Fragment","state":"DESTROYED","detail":"Hidden until the Horcrux revelation in a later year.","secret":true},{"level":48,"book":2,"cat":"allies","name":"Dobby","state":"True Ally","detail":"Harry outmanoeuvres Lucius and frees Dobby.","payoff":"Warning \u2192 rescue \u2192 loyalty"},{"level":48,"book":2,"cat":"character","name":"Independent Courage","state":"Strengthened","detail":"Harry completes a lethal rescue mission despite adult failure around him."}]
};
...
function battleCategoryState(cat){
 const items=BATTLE_PROTO.items.filter(i=>i.cat===cat.id&&battleVisible(i));
 const unlocked=items.filter(battleUnlocked);
 return {items,unlocked};
}
function battleItemHtml(i){
 const unlocked=battleUnlocked(i);
 return `<article class="readiness-item ${unlocked?'unlocked':'locked'}">
   <div class="readiness-item-top"><span class="readiness-level">LV ${i.level}</span><span class="readiness-state">${unlocked?escapeHtml(i.state):'LOCKED'}</span></div>
   <h4>${unlocked?escapeHtml(i.name):'Unknown preparation'}</h4>
   <p>${unlocked?escapeHtml(i.detail):`Reach Level ${i.level} to reveal this preparation.`}</p>
   ${unlocked&&i.payoff?`<div class="payoff-chip">🔗 PAYOFF <b>${escapeHtml(i.payoff)}</b></div>`:''}
 </article>`;
}
function renderCollection(){
 const hub=document.querySelector('#collectionHub'); if(!hub)return;
 const level=Math.max(1,save.currentLevel), book=Math.min(2,Math.ceil(level/24));
 const visibleItems=BATTLE_PROTO.items.filter(battleVisible);
 const unlocked=visibleItems.filter(battleUnlocked);
 const selected=ui.collectionCategory;

 if(selected){
   const cat=BATTLE_PROTO.categories.find(c=>c.id===selected);
   const state=battleCategoryState(cat);
   if(cat.id==='horcrux'){
     hub.innerHTML=`<button id="collectionBack" class="back-button" type="button">← Battle Readiness</button>
       <section class="classified-panel"><div class="classified-skull">☠</div><span>CLASSIFIED</span><h2>Horcrux War</h2>
       <p>Harry does not yet understand the true nature of Voldemort's immortality.</p>
       <div class="classified-lock">INTELLIGENCE LOCKED</div></section>`;
   }else{
     hub.innerHTML=`<button id="collectionBack" class="back-button" type="button">← Battle Readiness</button>
       <section class="readiness-category-hero"><span class="readiness-big-icon">${cat.icon}</span><div><span class="eyebrow">${state.unlocked.length} / ${state.items.length} DEVELOPED</span><h2>${escapeHtml(cat.name)}</h2><p>${escapeHtml(cat.desc)}</p></div></section>
       <div class="readiness-list">${state.items.map(battleItemHtml).join('')}</div>`;
   }
   hub.querySelector('#collectionBack').onclick=()=>{ui.collectionCategory=null;renderCollection();};
   return;
 }

 const book1=unlocked.filter(i=>i.book===1).length, book2=unlocked.filter(i=>i.book===2).length;
 const last=unlocked.slice().sort((a,b)=>b.level-a.level).slice(0,3);
 hub.innerHTML=`
   <section class="battle-hero">
     <span class="battle-kicker">HARRY POTTER • LEVEL ${level}</span>
     <h3>${level<=24?'THE FOUNDATIONS':'THE FIRST DARK ARTEFACT'}</h3>
     <p>${level<=24?'Awaken. Train. Survive.':'Investigate. Duel. Strike.'}</p>
     <div class="battle-meter"><i style="width:${Math.min(100,(level/48)*100)}%"></i></div>
     <div class="battle-meter-copy"><b>PROTOTYPE READINESS</b><span>${Math.min(level,48)} / 48 levels tested</span></div>
   </section>

   <section class="year-war-grid">
     <div class="year-war-card ${book>=1?'active':''}"><span>BOOK I</span><b>Survive & Awaken</b><small>${book1} readiness gains unlocked</small></div>
     <div class="year-war-card ${book>=2?'active':''}"><span>BOOK II</span><b>Investigate & Strike</b><small>${book2} readiness gains unlocked</small></div>
   </section>

   ${last.length?`<section class="latest-training"><span class="eyebrow">LATEST DEVELOPMENT</span>${last.map(i=>`<div class="latest-readiness"><b>${escapeHtml(i.name)}</b><span>${escapeHtml(i.state)}</span>${i.payoff?`<small>🔗 ${escapeHtml(i.payoff)}</small>`:''}</div>`).join('')}</section>`:''}

   <section class="readiness-grid">
   ${BATTLE_PROTO.categories.map(cat=>{
      if(cat.id==='horcrux') return `<button class="readiness-door classified" data-category="${cat.id}"><span class="r-icon">${cat.icon}</span><div><b>${cat.name}</b><small>CLASSIFIED • LOCKED</small></div><em>›</em></button>`;
      const s=battleCategoryState(cat), pct=s.items.length?Math.round(s.unlocked.length/s.items.length*100):0;
      return `<button class="readiness-door" data-category="${cat.id}"><span class="r-icon">${cat.icon}</span><div><b>${cat.name}</b><small>${s.unlocked.length} / ${s.items.length} developed</small><i><u style="width:${pct}%"></u></i></div><em>›</em></button>`;
   }).join('')}
   </section>

   <section class="battle-prototype-note"><b>BOOKS 1–2 PROTOTYPE</b><span>Later years remain sealed while we test whether this battle-preparation loop feels exciting.</span></section>`;
...
function render(){renderHome();renderCollection();renderStats();}
function escapeHtml(s){return String(s??'').replace(/[&<>'"]/g,m=>({'&':'&amp;','<':'&lt;','>':'&gt;',"'":'&#039;','"':'&quot;'}[m]));}

function setupUI(){
  document.querySelectorAll('.bottom-nav button').forEach(b=>b.onclick=()=>{document.querySelectorAll('.bottom-nav button').forEach(x=>x.classList.toggle('active',x===b));document.querySelectorAll('.view').forEach(v=>v.classList.toggle('active',v.id===`view-${b.dataset.view}`));if(b.dataset.view==='journey'){try{renderJourney();}catch(e){console.error(e);}}if(b.dataset.view==='collection')renderCollection();if(b.dataset.view==='stats')renderStats();window.scrollTo({top:0,behavior:'smooth'});});
